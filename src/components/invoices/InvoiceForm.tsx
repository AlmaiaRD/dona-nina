      ...
      <div className="space-y-5">
        <div>
          ...
          <div className="flex gap-2">
            <select
              ...
              className="flex-1 h-12 px-4 rounded-xl border border-[#E8E0D8] bg-[#FDF8F3] text-[#3D2B1F] text-sm focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all"
            >
        ...
        <div>
          ...
          <input
            ...
            className="w-full h-12 px-4 rounded-xl border border-[#E8E0D8] bg-[#FDF8F3] text-[#3D2B1F] text-sm focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all"
          />
        </div>
              ...
              <div className="p-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-10 pl-9 pr-3 rounded-lg border border-[#E8E0D8] bg-white text-sm text-[#3D2B1F] placeholder:text-[#9C8A82] focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all"
                    autoFocus
                  />
                </div>
              </div>
            ...
            <div className="mb-4 bg-[#FDF8F3] rounded-xl p-4 space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full h-10 px-3 rounded-lg border border-[#E8E0D8] bg-white text-sm text-[#3D2B1F] placeholder:text-[#9C8A82] focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all"
                  autoFocus
                />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-10 px-3 rounded-lg border border-[#E8E0D8] bg-white text-sm text-center focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all"
                  />
                </div>
                <div>
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-4 py-3 rounded-xl border border-[#E8E0D8] bg-[#FDF8F3] text-[#3D2B1F] text-sm placeholder:text-[#9C8A82] focus:outline-none focus:ring-2 focus:ring-[#7C1D2E]/30/30 focus:border-[#7C1D2E]/20 transition-all resize-none"
          />
        </div>
