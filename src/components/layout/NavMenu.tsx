...
import {
  ...
  BarChart3, Settings, File, BookOpen, X,
} from 'lucide-react'
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-gray-800">
          ...
          <button onClick={onClose} className="lg:hidden p-1 text-[#9C8A82] hover:text-white">
            <X className="h-5 w-5" />
          </button>
        </div>
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : 'text-[#9C8A82] hover:bg-gray-800 hover:text-white'
                )}
              >
