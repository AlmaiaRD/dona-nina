          ...
          <div className="space-y-4">
            ...
            <div id="expense-detail" className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Fecha</p>
                  <p className="text-sm text-gray-900 mt-0.5">{formatDateShort(detailExpense.expense_date)}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Categoría</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailExpense.category}</p>
                </div>
                <div className="sm:col-span-2">
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Concepto</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailExpense.concept}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Monto</p>
                  <p className="text-sm text-gray-900 mt-0.5">{formatCurrency(detailExpense.amount)}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Método de Pago</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailExpense.payment_method}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Beneficiario</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailExpense.beneficiary || '—'}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">N° Recibo</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailExpense.receipt_number || '—'}</p>
                </div>
                {detailExpense.notes && (
                  <div className="sm:col-span-2">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Notas</p>
                    <p className="text-sm text-gray-900 mt-0.5">{detailExpense.notes}</p>
                  </div>
                )}
              </div>
            </div>
