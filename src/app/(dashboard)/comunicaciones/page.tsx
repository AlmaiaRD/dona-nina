            ...
            <div id="communication-detail" className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-900 mt-0.5">{detailComm.client?.full_name || '—'}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Tipo</p>
                  <p className="text-sm text-gray-900 mt-0.5 capitalize">{detailComm.type}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Dirección</p>
                  <p className="text-sm text-gray-900 mt-0.5 capitalize">{detailComm.direction === 'outgoing' ? 'Saliente' : 'Entrante'}</p>
                </div>
                <div>
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Estado</p>
                  <p className="text-sm text-gray-900 mt-0.5 capitalize">{detailComm.status}</p>
                </div>
                <div className="sm:col-span-2">
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Asunto</p>
                  <p className="text-sm text-gray-900 mt-0.5">{detailComm.subject || '—'}</p>
                </div>
                {detailComm.body && (
                  <div className="sm:col-span-2">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Cuerpo</p>
                    <p className="text-sm text-gray-900 mt-0.5 whitespace-pre-wrap">{detailComm.body}</p>
                  </div>
                )}
                <div className="sm:col-span-2">
                  <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Fecha de Creación</p>
                  <p className="text-sm text-gray-900 mt-0.5">{formatDateShort(detailComm.created_at)}</p>
                </div>
              </div>
            </div>
          </div>
